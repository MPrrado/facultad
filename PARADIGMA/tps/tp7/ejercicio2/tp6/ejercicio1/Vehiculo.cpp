...
Auto :: Auto(string patente, int anioModelo, double pesoMax, double tarifa, double limiteMinN): Vehiculo(patente,anioModelo,pesoMax,tarifa), limiteMin(limiteMinN)
{
...
Moto :: ~Moto()
{
    cout<<"Se destruye una moto"<<endl;
}
